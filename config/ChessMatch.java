...
import project.chess.config.pieces.Knight;
import project.chess.config.pieces.Pawn;
import project.chess.config.pieces.Queen;
...
public class ChessMatch {
	...
	public ChessPiece replacePromotedPiece(String type) {
		...
		if (!type.equals("B") && !type.equals("N") && !type.equals("B") && !type.equals("Q")) {
			return promoted;
		}
	...
	private Piece makeMove(Position source, Position target) {
		...
		if (p instanceof Pawn) {
			// Peão andou na diagonal e não capturou peça (sinaliza en Passant):
	...
	private void undoMove(Position source, Position target, Piece capturedPiece) {
		...
		// # Special move: en passant
		if (p instanceof Pawn) {
			// Retorno da peça que sofreu enPassant:
	...
	private void initialSetup() {
		...
		// Último parâmetro do rei é a passagem da partida:
